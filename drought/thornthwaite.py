...
#-----------------------------------------------------------------------------------------------------------------------
@numba.jit
def potential_evapotranspiration(latitude_degrees, 
                                 data_start_year):
    '''
    ...
    * *I* is a heat index which depends on the 12 monthly mean temperatures and is calculated as 
    ...
    '''
    monthly_temps_celsius=[26.404,27.091,27.69,29.636,30.443,30.301,29.416,28.944,28.745,27.873,26.102,24.818,
